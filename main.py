import os
import sys, zipfile, shutil, win32con, win32api, atexit
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ProcessBar.setGeometry(QtCore.QRect(20, 200, 540, 61))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        self.ProcessBar.setFont(font)
        self.ProcessBar.setStyleSheet("QLabel {\n"
                                      "    color: white;\n"
                                      "    background-color: rgb(39, 39, 39);\n"
                                      "    border: 0px;\n"
                                      "    border-radius: 7px;\n"
                                      "}")
        self.ProcessBar.setAlignment(QtCore.Qt.AlignLeading | QtCore.Qt.AlignLeft | QtCore.Qt.AlignTop)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ProcessBar.setText(self.translate("MainWindow", "    输出进度"))
    ...
    def Open(self):  # 文件打开方法
        ...
        try:
            ...
            win32api.MessageBox(0,
                                "您可能选择了一个不正确的资源包\n若您坚信您选择的资源包没有问题且此问题频繁出现，请前往GitHub反馈",
